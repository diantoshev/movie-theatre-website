import "./AddCinemaContainer.scss";
import GoldContainer from "../../../../components/GoldContainer/GoldContainer";
import Form from "react-bootstrap/Form";
import DarkButton from "../../../../components/Buttons/DarkButton";

export default function AddCinemaContainer() {
  return (
    <GoldContainer className="add-theater-form-container">
      <Form>
        <div>
          <Form.Group className="mb-3" controlId="formTitle">
            <Form.Label className="add-theater-form-title">
              Add New Theater
            </Form.Label>
          </Form.Group>
